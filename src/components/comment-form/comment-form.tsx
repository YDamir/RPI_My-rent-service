...
function CommentForm({ onCommentSubmit }: { onCommentSubmit: (comment: string, rating: number) => void }) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        if (!rating || commentText.length < 50) {
            alert("Please fill in all fields before submitting.");
            return;
        }

        onCommentSubmit(commentText, rating);
